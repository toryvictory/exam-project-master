...
import { mdiChevronDown, mdiMenu, mdiWindowClose  } from '@mdi/js';
...
const DropDownNavigation = () => {
    ...
    return (
        <>
            <div onClick={() => toggleShowMenu(!showMenu)} className={styles.menuButton}>
                <Icon path={showMenu ? mdiWindowClose : mdiMenu} className={styles.iconMenu}/>
            </div>
            <div className={
                classNames( styles.nav, { [styles.showNav]: showMenu})
            }>
